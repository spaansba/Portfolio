        ...
        <div className="flex flex-col md:flex-row md:gap-10 lg:gap-20 items-center md:items-start">
          <div className="w-full md:max-w-[500px] order-2 md:order-1">
            ...
            <p className="font-medium text-base md:text-lg pt-5 text-TextGray leading-relaxed">
              I am a self-taught hobby frontend developer from Rotterdam, The Netherlands. I aspire
              to become a full-time frontend developer.
            </p>
          ...
          <div className="relative size-[150px] md:size-[200px] lg:size-[300px] flex-shrink-0 mb-6 md:mb-0 order-1 md:order-2">
            <div className="absolute right-[-10px] top-[10px] md:right-[-30px] md:top-[30px] size-full border-TertiaryGray border-[1px]"></div>
            <Image
